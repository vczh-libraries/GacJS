...
export interface IRemoteProtocolRequests {
    ...
    RequestWindowNotifySetTitle(requestArgs: TYPES.String): void;
    RequestWindowNotifySetEnabled(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetTopMost(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetShowInTaskBar(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetCustomFrameMode(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetMaximizedBox(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetMinimizedBox(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetBorder(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetSizeBox(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetIconVisible(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetTitleBar(requestArgs: TYPES.Boolean): void;
    RequestWindowNotifySetBounds(requestArgs: NativeRect): void;
    ...
    RequestRendererBeginBoundary(requestArgs: ElementBoundary): void;
...
export interface IRemoteProtocolEvents {
    ...
    OnControllerScreenUpdated(eventArgs: ScreenConfig): void;
    OnWindowBoundsUpdated(eventArgs: WindowSizingConfig): void;
    OnWindowActivatedUpdated(eventArgs: TYPES.Boolean): void;
    OnIOGlobalShortcutKey(eventArgs: TYPES.Integer): void;
    OnIOButtonDown(eventArgs: IOMouseInfoWithButton): void;
    OnIOButtonDoubleClick(eventArgs: IOMouseInfoWithButton): void;
    OnIOButtonUp(eventArgs: IOMouseInfoWithButton): void;
    OnIOHWheel(eventArgs: IOMouseInfo): void;
    OnIOVWheel(eventArgs: IOMouseInfo): void;
    OnIOMouseMoving(eventArgs: IOMouseInfo): void;
    OnIOMouseEntered(): void;
    OnIOMouseLeaved(): void;
    OnIOKeyDown(eventArgs: IOKeyInfo): void;
    OnIOKeyUp(eventArgs: IOKeyInfo): void;
    OnIOChar(eventArgs: IOCharInfo): void;
}
